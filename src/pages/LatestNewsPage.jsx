...
const LatestNewsPage = () => {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div className="w-1 bg-white px-1">{/* Sidebar content */}</div>
      ...
      <div className="flex-1 bg-blue-50 mr-4 pl-5 pr-5">
        ...
        <p className="text-gray-700 font-bold font-mono h-24">
          Your hub for the latest news on India's thriving startup scene. Stay
          updated with the freshest insights, trends, and success stories
          shaping the future of entrepreneurship in India. Dive in now for your
          daily dose of startup news!
        </p>
